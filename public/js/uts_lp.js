...
var uts_now = '2018-11-18 04:29:20';
...
var exdate=new Date();var c_lctid='';if(!lc_val){var lc_val=uts_getQueryStringValue('lctid')}
if(lc_val&&!uts_readCookie('uts_lctid')){exdate.setTime(exdate.getTime()+(uts_duration*24*60*60*1000));document.cookie='uts_lctid='+lc_val+'; expires='+exdate.toUTCString()+'; path=/; domain=.'+uts_domain+';';var c_lctid=lc_val}
var uts_samedomain=!1;if(lc_aref.search(uts_domain)>=0){uts_samedomain=!0}
